...
/*        gc.setMapperName("%sMapper");
        ...
        dsc.setUrl("jdbc:mysql://8.129.187.163:3306/star?useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.mikechen.star");   //自定义包的路径
        ...
        strategy.setInclude("user");    //设置映射的表名，可以设置多个表
