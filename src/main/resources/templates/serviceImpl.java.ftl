...
<#if field.keyFlag>
    ...
    */
    ...
    public Integer delete${entity}By${field.propertyName}(@Param("${field.propertyName}") ${field.propertyType} ${field.propertyName}) {
        return ${table.entityPath}Mapper.delete${entity}By${field.propertyName}(${field.propertyName});
    }
</#if>
</#list>
...
<#if field.keyFlag>
    ...
    */
    ...
    public Integer update${entity}By${field.propertyName}(${entity} ${table.entityPath}) {
        return ${table.entityPath}Mapper.update${entity}By${field.propertyName}(${table.entityPath});
    }
</#if>
</#list>
